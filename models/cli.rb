class CLI  
    ...
    def create_watch_list
        ...
        puts "Your selected counties have been added to your watchlist!"
    end

    def return_home
       return_home = prompt3 = TTY::Prompt.new
        prompt3.select("Menu") do |menu|
            menu.choice "Return Home", -> {main_menu}
        end
    end
